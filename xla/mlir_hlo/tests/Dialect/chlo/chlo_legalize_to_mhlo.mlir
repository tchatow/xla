...
// CHECK: %[[TEMP_19:.*]] = mhlo.constant dense<2.000000e+00> : tensor<f32>
// CHECK: %[[TEMP_20:.*]] = mhlo.sqrt %[[TEMP_19]] : tensor<f32>
// CHECK: %[[TEMP_21:.*]] = mhlo.multiply %[[TEMP_20]], %[[TEMP_16]] : tensor<f32>
// CHECK: %[[TEMP_22:.*]] = mhlo.divide %[[TEMP_17]], %[[TEMP_16]] : tensor<f32>
// CHECK: %[[TEMP_23:.*]] = mhlo.multiply %[[TEMP_22]], %[[TEMP_22]] : tensor<f32>
// CHECK: %[[TEMP_24:.*]] = mhlo.add %[[TEMP_11]], %[[TEMP_23]] : tensor<f32>
// CHECK: %[[TEMP_25:.*]] = mhlo.sqrt %[[TEMP_24]] : tensor<f32>
// CHECK: %[[TEMP_26:.*]] = mhlo.compare  EQ, %[[TEMP_25]], %[[TEMP_11]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK: %[[TEMP_27:.*]] = mhlo.constant dense<0.000000e+00> : tensor<f32>
// CHECK: %[[TEMP_28:.*]] = mhlo.compare  GT, %[[TEMP_23]], %[[TEMP_27]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK: %[[TEMP_29:.*]] = mhlo.and %[[TEMP_26]], %[[TEMP_28]] : tensor<i1>
// CHECK: %[[TEMP_30:.*]] = mhlo.multiply %[[TEMP_16]], %[[TEMP_23]] : tensor<f32>
// CHECK: %[[TEMP_31:.*]] = mhlo.divide %[[TEMP_30]], %[[TEMP_19]] : tensor<f32>
// CHECK: %[[TEMP_32:.*]] = mhlo.add %[[TEMP_16]], %[[TEMP_31]] : tensor<f32>
// CHECK: %[[TEMP_33:.*]] = mhlo.multiply %[[TEMP_16]], %[[TEMP_25]] : tensor<f32>
// CHECK: %[[TEMP_34:.*]] = mhlo.select %[[TEMP_29]], %[[TEMP_32]], %[[TEMP_33]] : tensor<i1>, tensor<f32>
// CHECK: %[[TEMP_35:.*]] = mhlo.select %[[TEMP_18]], %[[TEMP_21]], %[[TEMP_34]] : tensor<i1>, tensor<f32>
...
// CHECK: %[[TEMP_41:.*]] = mhlo.multiply %[[TEMP_20]], %[[TEMP_38]] : tensor<f32>
...
// CHECK: %[[TEMP_47:.*]] = mhlo.compare  GT, %[[TEMP_43]], %[[TEMP_27]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK: %[[TEMP_48:.*]] = mhlo.and %[[TEMP_46]], %[[TEMP_47]] : tensor<i1>
// CHECK: %[[TEMP_49:.*]] = mhlo.multiply %[[TEMP_38]], %[[TEMP_43]] : tensor<f32>
// CHECK: %[[TEMP_50:.*]] = mhlo.divide %[[TEMP_49]], %[[TEMP_19]] : tensor<f32>
...
// CHECK: %[[TEMP_86:.*]] = mhlo.log %[[TEMP_19]] : tensor<f32>
...
// CHECK: %[[TEMP_94:.*]] = mhlo.select %[[TEMP_92]], %[[TEMP_93]], %[[TEMP_27]] : tensor<i1>, tensor<f32>
...
// CHECK: %[[TEMP_134:.*]] = mhlo.imag %[[TEMP_130]] : (tensor<complex<f32>>) -> tensor<f32>
// CHECK: %[[TEMP_135:.*]] = mhlo.constant dense<0.000000e+00> : tensor<f32>
// CHECK: %[[TEMP_136:.*]] = mhlo.compare  LT, %[[TEMP_133]], %[[TEMP_135]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK: %[[TEMP_137:.*]] = mhlo.negate %[[TEMP_134]] : tensor<f32>
// CHECK: %[[TEMP_138:.*]] = mhlo.select %[[TEMP_136]], %[[TEMP_137]], %[[TEMP_134]] : tensor<i1>, tensor<f32>
...
// CHECK: %[[TEMP_27:.*]] = mhlo.constant dense<2.000000e+00> : tensor<f64>
...
// CHECK: %[[TEMP_30:.*]] = mhlo.sqrt %[[TEMP_29]] : tensor<?xf64>
// CHECK: %[[TEMP_31:.*]] = mhlo.multiply %[[TEMP_30]], %[[TEMP_24]] : tensor<?xf64>
// CHECK: %[[TEMP_32:.*]] = mhlo.divide %[[TEMP_25]], %[[TEMP_24]] : tensor<?xf64>
// CHECK: %[[TEMP_33:.*]] = mhlo.multiply %[[TEMP_32]], %[[TEMP_32]] : tensor<?xf64>
// CHECK: %[[TEMP_34:.*]] = mhlo.add %[[TEMP_17]], %[[TEMP_33]] : tensor<?xf64>
// CHECK: %[[TEMP_35:.*]] = mhlo.sqrt %[[TEMP_34]] : tensor<?xf64>
// CHECK: %[[TEMP_36:.*]] = mhlo.compare  EQ, %[[TEMP_35]], %[[TEMP_17]] : (tensor<?xf64>, tensor<?xf64>) -> tensor<?xi1>
// CHECK: %[[TEMP_37:.*]] = mhlo.constant dense<0.000000e+00> : tensor<f64>
// CHECK: %[[TEMP_38:.*]] = shape.shape_of %[[TEMP_1]] : tensor<?xf64> -> tensor<1xindex>
// CHECK: %[[TEMP_39:.*]] = "mhlo.dynamic_broadcast_in_dim"(%[[TEMP_37]], %[[TEMP_38]]) <{broadcast_dimensions = dense<> : tensor<0xi64>}> : (tensor<f64>, tensor<1xindex>) -> tensor<?xf64>
// CHECK: %[[TEMP_40:.*]] = mhlo.compare  GT, %[[TEMP_33]], %[[TEMP_39]] : (tensor<?xf64>, tensor<?xf64>) -> tensor<?xi1>
// CHECK: %[[TEMP_41:.*]] = mhlo.and %[[TEMP_36]], %[[TEMP_40]] : tensor<?xi1>
// CHECK: %[[TEMP_42:.*]] = mhlo.multiply %[[TEMP_24]], %[[TEMP_33]] : tensor<?xf64>
// CHECK: %[[TEMP_43:.*]] = mhlo.divide %[[TEMP_42]], %[[TEMP_29]] : tensor<?xf64>
// CHECK: %[[TEMP_44:.*]] = mhlo.add %[[TEMP_24]], %[[TEMP_43]] : tensor<?xf64>
// CHECK: %[[TEMP_45:.*]] = mhlo.multiply %[[TEMP_24]], %[[TEMP_35]] : tensor<?xf64>
// CHECK: %[[TEMP_46:.*]] = mhlo.select %[[TEMP_41]], %[[TEMP_44]], %[[TEMP_45]] : tensor<?xi1>, tensor<?xf64>
// CHECK: %[[TEMP_47:.*]] = mhlo.select %[[TEMP_26]], %[[TEMP_31]], %[[TEMP_46]] : tensor<?xi1>, tensor<?xf64>
// CHECK: %[[TEMP_48:.*]] = mhlo.subtract %[[TEMP_2]], %[[TEMP_17]] : tensor<?xf64>
// CHECK: %[[TEMP_49:.*]] = mhlo.abs %[[TEMP_48]] : tensor<?xf64>
// CHECK: %[[TEMP_50:.*]] = mhlo.maximum %[[TEMP_49]], %[[TEMP_4]] : tensor<?xf64>
// CHECK: %[[TEMP_51:.*]] = mhlo.minimum %[[TEMP_49]], %[[TEMP_4]] : tensor<?xf64>
// CHECK: %[[TEMP_52:.*]] = mhlo.compare  EQ, %[[TEMP_50]], %[[TEMP_51]] : (tensor<?xf64>, tensor<?xf64>) -> tensor<?xi1>
// CHECK: %[[TEMP_53:.*]] = mhlo.multiply %[[TEMP_30]], %[[TEMP_50]] : tensor<?xf64>
// CHECK: %[[TEMP_54:.*]] = mhlo.divide %[[TEMP_51]], %[[TEMP_50]] : tensor<?xf64>
// CHECK: %[[TEMP_55:.*]] = mhlo.multiply %[[TEMP_54]], %[[TEMP_54]] : tensor<?xf64>
// CHECK: %[[TEMP_56:.*]] = mhlo.add %[[TEMP_17]], %[[TEMP_55]] : tensor<?xf64>
// CHECK: %[[TEMP_57:.*]] = mhlo.sqrt %[[TEMP_56]] : tensor<?xf64>
// CHECK: %[[TEMP_58:.*]] = mhlo.compare  EQ, %[[TEMP_57]], %[[TEMP_17]] : (tensor<?xf64>, tensor<?xf64>) -> tensor<?xi1>
// CHECK: %[[TEMP_59:.*]] = mhlo.compare  GT, %[[TEMP_55]], %[[TEMP_39]] : (tensor<?xf64>, tensor<?xf64>) -> tensor<?xi1>
// CHECK: %[[TEMP_60:.*]] = mhlo.and %[[TEMP_58]], %[[TEMP_59]] : tensor<?xi1>
// CHECK: %[[TEMP_61:.*]] = mhlo.multiply %[[TEMP_50]], %[[TEMP_55]] : tensor<?xf64>
// CHECK: %[[TEMP_62:.*]] = mhlo.divide %[[TEMP_61]], %[[TEMP_29]] : tensor<?xf64>
// CHECK: %[[TEMP_63:.*]] = mhlo.add %[[TEMP_50]], %[[TEMP_62]] : tensor<?xf64>
// CHECK: %[[TEMP_64:.*]] = mhlo.multiply %[[TEMP_50]], %[[TEMP_57]] : tensor<?xf64>
// CHECK: %[[TEMP_65:.*]] = mhlo.select %[[TEMP_60]], %[[TEMP_63]], %[[TEMP_64]] : tensor<?xi1>, tensor<?xf64>
// CHECK: %[[TEMP_66:.*]] = mhlo.select %[[TEMP_52]], %[[TEMP_53]], %[[TEMP_65]] : tensor<?xi1>, tensor<?xf64>
// CHECK: %[[TEMP_67:.*]] = mhlo.add %[[TEMP_47]], %[[TEMP_66]] : tensor<?xf64>
// CHECK: %[[TEMP_68:.*]] = mhlo.multiply %[[TEMP_21]], %[[TEMP_67]] : tensor<?xf64>
// CHECK: %[[TEMP_69:.*]] = mhlo.add %[[TEMP_68]], %[[TEMP_2]] : tensor<?xf64>
// CHECK: %[[TEMP_70:.*]] = mhlo.multiply %[[TEMP_21]], %[[TEMP_69]] : tensor<?xf64>
// CHECK: %[[TEMP_71:.*]] = mhlo.multiply %[[TEMP_4]], %[[TEMP_4]] : tensor<?xf64>
// CHECK: %[[TEMP_72:.*]] = mhlo.add %[[TEMP_47]], %[[TEMP_22]] : tensor<?xf64>
// CHECK: %[[TEMP_73:.*]] = mhlo.divide %[[TEMP_71]], %[[TEMP_72]] : tensor<?xf64>
// CHECK: %[[TEMP_74:.*]] = mhlo.subtract %[[TEMP_66]], %[[TEMP_48]] : tensor<?xf64>
// CHECK: %[[TEMP_75:.*]] = mhlo.add %[[TEMP_73]], %[[TEMP_74]] : tensor<?xf64>
// CHECK: %[[TEMP_76:.*]] = mhlo.multiply %[[TEMP_70]], %[[TEMP_75]] : tensor<?xf64>
// CHECK: %[[TEMP_77:.*]] = mhlo.sqrt %[[TEMP_76]] : tensor<?xf64>
// CHECK: %[[TEMP_78:.*]] = mhlo.divide %[[TEMP_70]], %[[TEMP_72]] : tensor<?xf64>
// CHECK: %[[TEMP_79:.*]] = mhlo.add %[[TEMP_66]], %[[TEMP_48]] : tensor<?xf64>
// CHECK: %[[TEMP_80:.*]] = mhlo.divide %[[TEMP_70]], %[[TEMP_79]] : tensor<?xf64>
// CHECK: %[[TEMP_81:.*]] = mhlo.add %[[TEMP_78]], %[[TEMP_80]] : tensor<?xf64>
// CHECK: %[[TEMP_82:.*]] = mhlo.sqrt %[[TEMP_81]] : tensor<?xf64>
// CHECK: %[[TEMP_83:.*]] = mhlo.multiply %[[TEMP_4]], %[[TEMP_82]] : tensor<?xf64>
// CHECK: %[[TEMP_84:.*]] = mhlo.select %[[TEMP_18]], %[[TEMP_77]], %[[TEMP_83]] : tensor<?xi1>, tensor<?xf64>
// CHECK: %[[TEMP_85:.*]] = mhlo.select %[[TEMP_14]], %[[TEMP_4]], %[[TEMP_84]] : tensor<?xi1>, tensor<?xf64>
// CHECK: %[[TEMP_86:.*]] = mhlo.constant dense<1.000000e+12> : tensor<f64>
// CHECK: %[[TEMP_87:.*]] = shape.shape_of %[[TEMP_1]] : tensor<?xf64> -> tensor<1xindex>
// CHECK: %[[TEMP_88:.*]] = "mhlo.dynamic_broadcast_in_dim"(%[[TEMP_86]], %[[TEMP_87]]) <{broadcast_dimensions = dense<> : tensor<0xi64>}> : (tensor<f64>, tensor<1xindex>) -> tensor<?xf64>
// CHECK: %[[TEMP_89:.*]] = mhlo.multiply %[[TEMP_13]], %[[TEMP_88]] : tensor<?xf64>
// CHECK: %[[TEMP_90:.*]] = mhlo.compare  LT, %[[TEMP_2]], %[[TEMP_89]] : (tensor<?xf64>, tensor<?xf64>) -> tensor<?xi1>
// CHECK: %[[TEMP_91:.*]] = mhlo.constant dense<9.9999999999999995E-7> : tensor<f64>
// CHECK: %[[TEMP_92:.*]] = shape.shape_of %[[TEMP_1]] : tensor<?xf64> -> tensor<1xindex>
// CHECK: %[[TEMP_93:.*]] = "mhlo.dynamic_broadcast_in_dim"(%[[TEMP_91]], %[[TEMP_92]]) <{broadcast_dimensions = dense<> : tensor<0xi64>}> : (tensor<f64>, tensor<1xindex>) -> tensor<?xf64>
// CHECK: %[[TEMP_94:.*]] = mhlo.multiply %[[TEMP_13]], %[[TEMP_93]] : tensor<?xf64>
// CHECK: %[[TEMP_95:.*]] = mhlo.constant dense<1.000000e+02> : tensor<f64>
// CHECK: %[[TEMP_96:.*]] = shape.shape_of %[[TEMP_1]] : tensor<?xf64> -> tensor<1xindex>
// CHECK: %[[TEMP_97:.*]] = "mhlo.dynamic_broadcast_in_dim"(%[[TEMP_95]], %[[TEMP_96]]) <{broadcast_dimensions = dense<> : tensor<0xi64>}> : (tensor<f64>, tensor<1xindex>) -> tensor<?xf64>
// CHECK: %[[TEMP_98:.*]] = mhlo.multiply %[[TEMP_13]], %[[TEMP_97]] : tensor<?xf64>
// CHECK: %[[TEMP_99:.*]] = mhlo.select %[[TEMP_90]], %[[TEMP_94]], %[[TEMP_98]] : tensor<?xi1>, tensor<?xf64>
// CHECK: %[[TEMP_100:.*]] = mhlo.compare  GE, %[[TEMP_4]], %[[TEMP_99]] : (tensor<?xf64>, tensor<?xf64>) -> tensor<?xi1>
// CHECK: %[[TEMP_101:.*]] = mhlo.select %[[TEMP_100]], %[[TEMP_4]], %[[TEMP_2]] : tensor<?xi1>, tensor<?xf64>
// CHECK: %[[TEMP_102:.*]] = mhlo.select %[[TEMP_100]], %[[TEMP_99]], %[[TEMP_13]] : tensor<?xi1>, tensor<?xf64>
// CHECK: %[[TEMP_103:.*]] = mhlo.compare  GE, %[[TEMP_101]], %[[TEMP_102]] : (tensor<?xf64>, tensor<?xf64>) -> tensor<?xi1>
// CHECK: %[[TEMP_104:.*]] = mhlo.log %[[TEMP_29]] : tensor<?xf64>
// CHECK: %[[TEMP_105:.*]] = mhlo.log %[[TEMP_101]] : tensor<?xf64>
// CHECK: %[[TEMP_106:.*]] = mhlo.add %[[TEMP_104]], %[[TEMP_105]] : tensor<?xf64>
// CHECK: %[[TEMP_107:.*]] = mhlo.constant dense<0x7FF0000000000000> : tensor<f64>
// CHECK: %[[TEMP_108:.*]] = shape.shape_of %[[TEMP_3]] : tensor<?xf64> -> tensor<1xindex>
// CHECK: %[[TEMP_109:.*]] = "mhlo.dynamic_broadcast_in_dim"(%[[TEMP_107]], %[[TEMP_108]]) <{broadcast_dimensions = dense<> : tensor<0xi64>}> : (tensor<f64>, tensor<1xindex>) -> tensor<?xf64>
// CHECK: %[[TEMP_110:.*]] = mhlo.compare  EQ, %[[TEMP_4]], %[[TEMP_109]] : (tensor<?xf64>, tensor<?xf64>) -> tensor<?xi1>
// CHECK: %[[TEMP_111:.*]] = mhlo.not %[[TEMP_110]] : tensor<?xi1>
// CHECK: %[[TEMP_112:.*]] = mhlo.and %[[TEMP_100]], %[[TEMP_111]] : tensor<?xi1>
// CHECK: %[[TEMP_113:.*]] = mhlo.divide %[[TEMP_2]], %[[TEMP_4]] : tensor<?xf64>
// CHECK: %[[TEMP_114:.*]] = mhlo.select %[[TEMP_112]], %[[TEMP_113]], %[[TEMP_39]] : tensor<?xi1>, tensor<?xf64>
// CHECK: %[[TEMP_115:.*]] = mhlo.multiply %[[TEMP_114]], %[[TEMP_114]] : tensor<?xf64>
// CHECK: %[[TEMP_116:.*]] = mhlo.log_plus_one %[[TEMP_115]] : tensor<?xf64>
// CHECK: %[[TEMP_117:.*]] = mhlo.multiply %[[TEMP_21]], %[[TEMP_116]] : tensor<?xf64>
// CHECK: %[[TEMP_118:.*]] = mhlo.add %[[TEMP_106]], %[[TEMP_117]] : tensor<?xf64>
// CHECK: %[[TEMP_119:.*]] = mhlo.constant dense<2.2250738585072014E-308> : tensor<f64>
// CHECK: %[[TEMP_120:.*]] = shape.shape_of %[[TEMP_1]] : tensor<?xf64> -> tensor<1xindex>
// CHECK: %[[TEMP_121:.*]] = "mhlo.dynamic_broadcast_in_dim"(%[[TEMP_119]], %[[TEMP_120]]) <{broadcast_dimensions = dense<> : tensor<0xi64>}> : (tensor<f64>, tensor<1xindex>) -> tensor<?xf64>
// CHECK: %[[TEMP_122:.*]] = mhlo.sqrt %[[TEMP_121]] : tensor<?xf64>
// CHECK: %[[TEMP_123:.*]] = mhlo.constant dense<4.000000e+00> : tensor<f64>
// CHECK: %[[TEMP_124:.*]] = shape.shape_of %[[TEMP_1]] : tensor<?xf64> -> tensor<1xindex>
// CHECK: %[[TEMP_125:.*]] = "mhlo.dynamic_broadcast_in_dim"(%[[TEMP_123]], %[[TEMP_124]]) <{broadcast_dimensions = dense<> : tensor<0xi64>}> : (tensor<f64>, tensor<1xindex>) -> tensor<?xf64>
// CHECK: %[[TEMP_126:.*]] = mhlo.multiply %[[TEMP_122]], %[[TEMP_125]] : tensor<?xf64>
// CHECK: %[[TEMP_127:.*]] = mhlo.compare  LT, %[[TEMP_4]], %[[TEMP_126]] : (tensor<?xf64>, tensor<?xf64>) -> tensor<?xi1>
// CHECK: %[[TEMP_128:.*]] = mhlo.compare  LT, %[[TEMP_2]], %[[TEMP_17]] : (tensor<?xf64>, tensor<?xf64>) -> tensor<?xi1>
// CHECK: %[[TEMP_129:.*]] = mhlo.and %[[TEMP_127]], %[[TEMP_128]] : tensor<?xi1>
// CHECK: %[[TEMP_130:.*]] = mhlo.multiply %[[TEMP_22]], %[[TEMP_48]] : tensor<?xf64>
// CHECK: %[[TEMP_131:.*]] = mhlo.add %[[TEMP_68]], %[[TEMP_17]] : tensor<?xf64>
// CHECK: %[[TEMP_132:.*]] = mhlo.divide %[[TEMP_130]], %[[TEMP_131]] : tensor<?xf64>
// CHECK: %[[TEMP_133:.*]] = mhlo.negate %[[TEMP_132]] : tensor<?xf64>
// CHECK: %[[TEMP_134:.*]] = mhlo.compare  GE, %[[TEMP_2]], %[[TEMP_17]] : (tensor<?xf64>, tensor<?xf64>) -> tensor<?xi1>
// CHECK: %[[TEMP_135:.*]] = mhlo.multiply %[[TEMP_21]], %[[TEMP_71]] : tensor<?xf64>
// CHECK: %[[TEMP_136:.*]] = mhlo.divide %[[TEMP_135]], %[[TEMP_72]] : tensor<?xf64>
// CHECK: %[[TEMP_137:.*]] = mhlo.multiply %[[TEMP_21]], %[[TEMP_79]] : tensor<?xf64>
// CHECK: %[[TEMP_138:.*]] = mhlo.add %[[TEMP_136]], %[[TEMP_137]] : tensor<?xf64>
// CHECK: %[[TEMP_139:.*]] = mhlo.constant dense<1.500000e+00> : tensor<f64>
// CHECK: %[[TEMP_140:.*]] = shape.shape_of %[[TEMP_1]] : tensor<?xf64> -> tensor<1xindex>
// CHECK: %[[TEMP_141:.*]] = "mhlo.dynamic_broadcast_in_dim"(%[[TEMP_139]], %[[TEMP_140]]) <{broadcast_dimensions = dense<> : tensor<0xi64>}> : (tensor<f64>, tensor<1xindex>) -> tensor<?xf64>
// CHECK: %[[TEMP_142:.*]] = mhlo.compare  LE, %[[TEMP_68]], %[[TEMP_141]] : (tensor<?xf64>, tensor<?xf64>) -> tensor<?xi1>
// CHECK: %[[TEMP_143:.*]] = mhlo.divide %[[TEMP_135]], %[[TEMP_74]] : tensor<?xf64>
// CHECK: %[[TEMP_144:.*]] = mhlo.add %[[TEMP_136]], %[[TEMP_143]] : tensor<?xf64>
// CHECK: %[[TEMP_145:.*]] = mhlo.subtract %[[TEMP_68]], %[[TEMP_17]] : tensor<?xf64>
// CHECK: %[[TEMP_146:.*]] = mhlo.select %[[TEMP_142]], %[[TEMP_144]], %[[TEMP_145]] : tensor<?xi1>, tensor<?xf64>
// CHECK: %[[TEMP_147:.*]] = mhlo.select %[[TEMP_134]], %[[TEMP_138]], %[[TEMP_146]] : tensor<?xi1>, tensor<?xf64>
// CHECK: %[[TEMP_148:.*]] = mhlo.select %[[TEMP_129]], %[[TEMP_133]], %[[TEMP_147]] : tensor<?xi1>, tensor<?xf64>
// CHECK: %[[TEMP_149:.*]] = mhlo.multiply %[[TEMP_148]], %[[TEMP_131]] : tensor<?xf64>
// CHECK: %[[TEMP_150:.*]] = mhlo.sqrt %[[TEMP_149]] : tensor<?xf64>
// CHECK: %[[TEMP_151:.*]] = mhlo.divide %[[TEMP_4]], %[[TEMP_150]] : tensor<?xf64>
// CHECK: %[[TEMP_152:.*]] = mhlo.add %[[TEMP_148]], %[[TEMP_150]] : tensor<?xf64>
// CHECK: %[[TEMP_153:.*]] = mhlo.log_plus_one %[[TEMP_152]] : tensor<?xf64>
// CHECK: %[[TEMP_154:.*]] = mhlo.select %[[TEMP_129]], %[[TEMP_151]], %[[TEMP_153]] : tensor<?xi1>, tensor<?xf64>
// CHECK: %[[TEMP_155:.*]] = mhlo.select %[[TEMP_103]], %[[TEMP_118]], %[[TEMP_154]] : tensor<?xi1>, tensor<?xf64>
// CHECK: %[[TEMP_156:.*]] = mhlo.complex %[[TEMP_85]], %[[TEMP_155]] : tensor<?xcomplex<f64>>
// CHECK: %[[TEMP_157:.*]] = mhlo.real %[[TEMP_156]] : (tensor<?xcomplex<f64>>) -> tensor<?xf64>
// CHECK: %[[TEMP_158:.*]] = mhlo.atan2 %[[TEMP_0]], %[[TEMP_157]] : tensor<?xf64>
// CHECK: %[[TEMP_159:.*]] = mhlo.imag %[[TEMP_arg0:.*]] : (tensor<?xcomplex<f64>>) -> tensor<?xf64>
// CHECK: %[[TEMP_160:.*]] = mhlo.imag %[[TEMP_156]] : (tensor<?xcomplex<f64>>) -> tensor<?xf64>
// CHECK: %[[TEMP_161:.*]] = mhlo.constant dense<0.000000e+00> : tensor<f64>
// CHECK: %[[TEMP_162:.*]] = shape.shape_of %[[TEMP_160]] : tensor<?xf64> -> tensor<1xindex>
// CHECK: %[[TEMP_163:.*]] = "mhlo.dynamic_broadcast_in_dim"(%[[TEMP_161]], %[[TEMP_162]]) <{broadcast_dimensions = dense<> : tensor<0xi64>}> : (tensor<f64>, tensor<1xindex>) -> tensor<?xf64>
// CHECK: %[[TEMP_164:.*]] = mhlo.compare  LT, %[[TEMP_159]], %[[TEMP_163]] : (tensor<?xf64>, tensor<?xf64>) -> tensor<?xi1>
// CHECK: %[[TEMP_165:.*]] = mhlo.negate %[[TEMP_160]] : tensor<?xf64>
// CHECK: %[[TEMP_166:.*]] = mhlo.select %[[TEMP_164]], %[[TEMP_165]], %[[TEMP_160]] : tensor<?xi1>, tensor<?xf64>
// CHECK: %[[TEMP_167:.*]] = mhlo.complex %[[TEMP_158]], %[[TEMP_166]] : tensor<?xcomplex<f64>>
// CHECK: return %[[TEMP_167]] : tensor<?xcomplex<f64>>
...
// CHECK-SAME:   %[[TEMP_arg0:.*]]: tensor<complex<f32>>) -> tensor<complex<f32>> {
// CHECK: %[[TEMP_0:.*]] = mhlo.real %[[TEMP_arg0:.*]] : (tensor<complex<f32>>) -> tensor<f32>
// CHECK: %[[TEMP_1:.*]] = mhlo.constant dense<0.000000e+00> : tensor<f32>
// CHECK: %[[TEMP_2:.*]] = mhlo.compare  LT, %[[TEMP_0]], %[[TEMP_1]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK: %[[TEMP_3:.*]] = mhlo.imag %[[TEMP_arg0:.*]] : (tensor<complex<f32>>) -> tensor<f32>
// CHECK: %[[TEMP_4:.*]] = mhlo.negate %[[TEMP_3]] : tensor<f32>
// CHECK: %[[TEMP_5:.*]] = mhlo.complex %[[TEMP_4]], %[[TEMP_0]] : tensor<complex<f32>>
// CHECK: %[[TEMP_6:.*]] = mhlo.real %[[TEMP_5]] : (tensor<complex<f32>>) -> tensor<f32>
// CHECK: %[[TEMP_7:.*]] = mhlo.abs %[[TEMP_6]] : tensor<f32>
// CHECK: %[[TEMP_8:.*]] = mhlo.imag %[[TEMP_5]] : (tensor<complex<f32>>) -> tensor<f32>
// CHECK: %[[TEMP_9:.*]] = mhlo.abs %[[TEMP_8]] : tensor<f32>
// CHECK: %[[TEMP_10:.*]] = mhlo.maximum %[[TEMP_7]], %[[TEMP_9]] : tensor<f32>
// CHECK: %[[TEMP_11:.*]] = mhlo.constant dense<3.40282347E+38> : tensor<f32>
// CHECK: %[[TEMP_12:.*]] = mhlo.sqrt %[[TEMP_11]] : tensor<f32>
// CHECK: %[[TEMP_13:.*]] = mhlo.constant dense<8.000000e+00> : tensor<f32>
// CHECK: %[[TEMP_14:.*]] = mhlo.divide %[[TEMP_12]], %[[TEMP_13]] : tensor<f32>
// CHECK: %[[TEMP_15:.*]] = mhlo.compare  GE, %[[TEMP_10]], %[[TEMP_14]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK: %[[TEMP_16:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f32>
// CHECK: %[[TEMP_17:.*]] = mhlo.compare  LE, %[[TEMP_7]], %[[TEMP_16]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK: %[[TEMP_18:.*]] = mhlo.constant dense<5.000000e-01> : tensor<f32>
// CHECK: %[[TEMP_19:.*]] = mhlo.add %[[TEMP_7]], %[[TEMP_16]] : tensor<f32>
// CHECK: %[[TEMP_20:.*]] = mhlo.abs %[[TEMP_19]] : tensor<f32>
// CHECK: %[[TEMP_21:.*]] = mhlo.maximum %[[TEMP_20]], %[[TEMP_9]] : tensor<f32>
// CHECK: %[[TEMP_22:.*]] = mhlo.minimum %[[TEMP_20]], %[[TEMP_9]] : tensor<f32>
// CHECK: %[[TEMP_23:.*]] = mhlo.compare  EQ, %[[TEMP_21]], %[[TEMP_22]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK: %[[TEMP_24:.*]] = mhlo.constant dense<2.000000e+00> : tensor<f32>
// CHECK: %[[TEMP_25:.*]] = mhlo.sqrt %[[TEMP_24]] : tensor<f32>
// CHECK: %[[TEMP_26:.*]] = mhlo.multiply %[[TEMP_25]], %[[TEMP_21]] : tensor<f32>
// CHECK: %[[TEMP_27:.*]] = mhlo.divide %[[TEMP_22]], %[[TEMP_21]] : tensor<f32>
// CHECK: %[[TEMP_28:.*]] = mhlo.multiply %[[TEMP_27]], %[[TEMP_27]] : tensor<f32>
// CHECK: %[[TEMP_29:.*]] = mhlo.add %[[TEMP_16]], %[[TEMP_28]] : tensor<f32>
// CHECK: %[[TEMP_30:.*]] = mhlo.sqrt %[[TEMP_29]] : tensor<f32>
// CHECK: %[[TEMP_31:.*]] = mhlo.compare  EQ, %[[TEMP_30]], %[[TEMP_16]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK: %[[TEMP_32:.*]] = mhlo.constant dense<0.000000e+00> : tensor<f32>
// CHECK: %[[TEMP_33:.*]] = mhlo.compare  GT, %[[TEMP_28]], %[[TEMP_32]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK: %[[TEMP_34:.*]] = mhlo.and %[[TEMP_31]], %[[TEMP_33]] : tensor<i1>
// CHECK: %[[TEMP_35:.*]] = mhlo.multiply %[[TEMP_21]], %[[TEMP_28]] : tensor<f32>
// CHECK: %[[TEMP_36:.*]] = mhlo.divide %[[TEMP_35]], %[[TEMP_24]] : tensor<f32>
// CHECK: %[[TEMP_37:.*]] = mhlo.add %[[TEMP_21]], %[[TEMP_36]] : tensor<f32>
// CHECK: %[[TEMP_38:.*]] = mhlo.multiply %[[TEMP_21]], %[[TEMP_30]] : tensor<f32>
// CHECK: %[[TEMP_39:.*]] = mhlo.select %[[TEMP_34]], %[[TEMP_37]], %[[TEMP_38]] : tensor<i1>, tensor<f32>
// CHECK: %[[TEMP_40:.*]] = mhlo.select %[[TEMP_23]], %[[TEMP_26]], %[[TEMP_39]] : tensor<i1>, tensor<f32>
// CHECK: %[[TEMP_41:.*]] = mhlo.subtract %[[TEMP_7]], %[[TEMP_16]] : tensor<f32>
// CHECK: %[[TEMP_42:.*]] = mhlo.abs %[[TEMP_41]] : tensor<f32>
// CHECK: %[[TEMP_43:.*]] = mhlo.maximum %[[TEMP_42]], %[[TEMP_9]] : tensor<f32>
// CHECK: %[[TEMP_44:.*]] = mhlo.minimum %[[TEMP_42]], %[[TEMP_9]] : tensor<f32>
// CHECK: %[[TEMP_45:.*]] = mhlo.compare  EQ, %[[TEMP_43]], %[[TEMP_44]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK: %[[TEMP_46:.*]] = mhlo.multiply %[[TEMP_25]], %[[TEMP_43]] : tensor<f32>
// CHECK: %[[TEMP_47:.*]] = mhlo.divide %[[TEMP_44]], %[[TEMP_43]] : tensor<f32>
// CHECK: %[[TEMP_48:.*]] = mhlo.multiply %[[TEMP_47]], %[[TEMP_47]] : tensor<f32>
// CHECK: %[[TEMP_49:.*]] = mhlo.add %[[TEMP_16]], %[[TEMP_48]] : tensor<f32>
// CHECK: %[[TEMP_50:.*]] = mhlo.sqrt %[[TEMP_49]] : tensor<f32>
// CHECK: %[[TEMP_51:.*]] = mhlo.compare  EQ, %[[TEMP_50]], %[[TEMP_16]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK: %[[TEMP_52:.*]] = mhlo.compare  GT, %[[TEMP_48]], %[[TEMP_32]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK: %[[TEMP_53:.*]] = mhlo.and %[[TEMP_51]], %[[TEMP_52]] : tensor<i1>
// CHECK: %[[TEMP_54:.*]] = mhlo.multiply %[[TEMP_43]], %[[TEMP_48]] : tensor<f32>
// CHECK: %[[TEMP_55:.*]] = mhlo.divide %[[TEMP_54]], %[[TEMP_24]] : tensor<f32>
// CHECK: %[[TEMP_56:.*]] = mhlo.add %[[TEMP_43]], %[[TEMP_55]] : tensor<f32>
// CHECK: %[[TEMP_57:.*]] = mhlo.multiply %[[TEMP_43]], %[[TEMP_50]] : tensor<f32>
// CHECK: %[[TEMP_58:.*]] = mhlo.select %[[TEMP_53]], %[[TEMP_56]], %[[TEMP_57]] : tensor<i1>, tensor<f32>
// CHECK: %[[TEMP_59:.*]] = mhlo.select %[[TEMP_45]], %[[TEMP_46]], %[[TEMP_58]] : tensor<i1>, tensor<f32>
// CHECK: %[[TEMP_60:.*]] = mhlo.add %[[TEMP_40]], %[[TEMP_59]] : tensor<f32>
// CHECK: %[[TEMP_61:.*]] = mhlo.multiply %[[TEMP_18]], %[[TEMP_60]] : tensor<f32>
// CHECK: %[[TEMP_62:.*]] = mhlo.add %[[TEMP_61]], %[[TEMP_7]] : tensor<f32>
// CHECK: %[[TEMP_63:.*]] = mhlo.multiply %[[TEMP_18]], %[[TEMP_62]] : tensor<f32>
// CHECK: %[[TEMP_64:.*]] = mhlo.multiply %[[TEMP_9]], %[[TEMP_9]] : tensor<f32>
// CHECK: %[[TEMP_65:.*]] = mhlo.add %[[TEMP_40]], %[[TEMP_19]] : tensor<f32>
// CHECK: %[[TEMP_66:.*]] = mhlo.divide %[[TEMP_64]], %[[TEMP_65]] : tensor<f32>
// CHECK: %[[TEMP_67:.*]] = mhlo.subtract %[[TEMP_59]], %[[TEMP_41]] : tensor<f32>
// CHECK: %[[TEMP_68:.*]] = mhlo.add %[[TEMP_66]], %[[TEMP_67]] : tensor<f32>
// CHECK: %[[TEMP_69:.*]] = mhlo.multiply %[[TEMP_63]], %[[TEMP_68]] : tensor<f32>
// CHECK: %[[TEMP_70:.*]] = mhlo.sqrt %[[TEMP_69]] : tensor<f32>
// CHECK: %[[TEMP_71:.*]] = mhlo.divide %[[TEMP_63]], %[[TEMP_65]] : tensor<f32>
// CHECK: %[[TEMP_72:.*]] = mhlo.add %[[TEMP_59]], %[[TEMP_41]] : tensor<f32>
// CHECK: %[[TEMP_73:.*]] = mhlo.divide %[[TEMP_63]], %[[TEMP_72]] : tensor<f32>
// CHECK: %[[TEMP_74:.*]] = mhlo.add %[[TEMP_71]], %[[TEMP_73]] : tensor<f32>
// CHECK: %[[TEMP_75:.*]] = mhlo.sqrt %[[TEMP_74]] : tensor<f32>
// CHECK: %[[TEMP_76:.*]] = mhlo.multiply %[[TEMP_9]], %[[TEMP_75]] : tensor<f32>
// CHECK: %[[TEMP_77:.*]] = mhlo.select %[[TEMP_17]], %[[TEMP_70]], %[[TEMP_76]] : tensor<i1>, tensor<f32>
// CHECK: %[[TEMP_78:.*]] = mhlo.select %[[TEMP_15]], %[[TEMP_9]], %[[TEMP_77]] : tensor<i1>, tensor<f32>
// CHECK: %[[TEMP_79:.*]] = mhlo.constant dense<9.99999995E+11> : tensor<f32>
// CHECK: %[[TEMP_80:.*]] = mhlo.multiply %[[TEMP_14]], %[[TEMP_79]] : tensor<f32>
// CHECK: %[[TEMP_81:.*]] = mhlo.compare  LT, %[[TEMP_7]], %[[TEMP_80]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK: %[[TEMP_82:.*]] = mhlo.constant dense<9.99999997E-7> : tensor<f32>
// CHECK: %[[TEMP_83:.*]] = mhlo.multiply %[[TEMP_14]], %[[TEMP_82]] : tensor<f32>
// CHECK: %[[TEMP_84:.*]] = mhlo.constant dense<1.000000e+02> : tensor<f32>
// CHECK: %[[TEMP_85:.*]] = mhlo.multiply %[[TEMP_14]], %[[TEMP_84]] : tensor<f32>
// CHECK: %[[TEMP_86:.*]] = mhlo.select %[[TEMP_81]], %[[TEMP_83]], %[[TEMP_85]] : tensor<i1>, tensor<f32>
// CHECK: %[[TEMP_87:.*]] = mhlo.compare  GE, %[[TEMP_9]], %[[TEMP_86]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK: %[[TEMP_88:.*]] = mhlo.select %[[TEMP_87]], %[[TEMP_9]], %[[TEMP_7]] : tensor<i1>, tensor<f32>
// CHECK: %[[TEMP_89:.*]] = mhlo.select %[[TEMP_87]], %[[TEMP_86]], %[[TEMP_14]] : tensor<i1>, tensor<f32>
// CHECK: %[[TEMP_90:.*]] = mhlo.compare  GE, %[[TEMP_88]], %[[TEMP_89]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK: %[[TEMP_91:.*]] = mhlo.log %[[TEMP_24]] : tensor<f32>
// CHECK: %[[TEMP_92:.*]] = mhlo.log %[[TEMP_88]] : tensor<f32>
// CHECK: %[[TEMP_93:.*]] = mhlo.add %[[TEMP_91]], %[[TEMP_92]] : tensor<f32>
// CHECK: %[[TEMP_94:.*]] = mhlo.constant dense<0x7F800000> : tensor<f32>
// CHECK: %[[TEMP_95:.*]] = mhlo.compare  EQ, %[[TEMP_9]], %[[TEMP_94]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK: %[[TEMP_96:.*]] = mhlo.not %[[TEMP_95]] : tensor<i1>
// CHECK: %[[TEMP_97:.*]] = mhlo.and %[[TEMP_87]], %[[TEMP_96]] : tensor<i1>
// CHECK: %[[TEMP_98:.*]] = mhlo.divide %[[TEMP_7]], %[[TEMP_9]] : tensor<f32>
// CHECK: %[[TEMP_99:.*]] = mhlo.select %[[TEMP_97]], %[[TEMP_98]], %[[TEMP_32]] : tensor<i1>, tensor<f32>
// CHECK: %[[TEMP_100:.*]] = mhlo.multiply %[[TEMP_99]], %[[TEMP_99]] : tensor<f32>
// CHECK: %[[TEMP_101:.*]] = mhlo.log_plus_one %[[TEMP_100]] : tensor<f32>
// CHECK: %[[TEMP_102:.*]] = mhlo.multiply %[[TEMP_18]], %[[TEMP_101]] : tensor<f32>
// CHECK: %[[TEMP_103:.*]] = mhlo.add %[[TEMP_93]], %[[TEMP_102]] : tensor<f32>
// CHECK: %[[TEMP_104:.*]] = mhlo.constant dense<1.17549435E-38> : tensor<f32>
// CHECK: %[[TEMP_105:.*]] = mhlo.sqrt %[[TEMP_104]] : tensor<f32>
// CHECK: %[[TEMP_106:.*]] = mhlo.constant dense<4.000000e+00> : tensor<f32>
// CHECK: %[[TEMP_107:.*]] = mhlo.multiply %[[TEMP_105]], %[[TEMP_106]] : tensor<f32>
// CHECK: %[[TEMP_108:.*]] = mhlo.compare  LT, %[[TEMP_9]], %[[TEMP_107]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK: %[[TEMP_109:.*]] = mhlo.compare  LT, %[[TEMP_7]], %[[TEMP_16]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK: %[[TEMP_110:.*]] = mhlo.and %[[TEMP_108]], %[[TEMP_109]] : tensor<i1>
// CHECK: %[[TEMP_111:.*]] = mhlo.multiply %[[TEMP_19]], %[[TEMP_41]] : tensor<f32>
// CHECK: %[[TEMP_112:.*]] = mhlo.add %[[TEMP_61]], %[[TEMP_16]] : tensor<f32>
// CHECK: %[[TEMP_113:.*]] = mhlo.divide %[[TEMP_111]], %[[TEMP_112]] : tensor<f32>
// CHECK: %[[TEMP_114:.*]] = mhlo.negate %[[TEMP_113]] : tensor<f32>
// CHECK: %[[TEMP_115:.*]] = mhlo.compare  GE, %[[TEMP_7]], %[[TEMP_16]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK: %[[TEMP_116:.*]] = mhlo.multiply %[[TEMP_18]], %[[TEMP_64]] : tensor<f32>
// CHECK: %[[TEMP_117:.*]] = mhlo.divide %[[TEMP_116]], %[[TEMP_65]] : tensor<f32>
// CHECK: %[[TEMP_118:.*]] = mhlo.multiply %[[TEMP_18]], %[[TEMP_72]] : tensor<f32>
// CHECK: %[[TEMP_119:.*]] = mhlo.add %[[TEMP_117]], %[[TEMP_118]] : tensor<f32>
// CHECK: %[[TEMP_120:.*]] = mhlo.constant dense<1.500000e+00> : tensor<f32>
// CHECK: %[[TEMP_121:.*]] = mhlo.compare  LE, %[[TEMP_61]], %[[TEMP_120]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK: %[[TEMP_122:.*]] = mhlo.divide %[[TEMP_116]], %[[TEMP_67]] : tensor<f32>
// CHECK: %[[TEMP_123:.*]] = mhlo.add %[[TEMP_117]], %[[TEMP_122]] : tensor<f32>
// CHECK: %[[TEMP_124:.*]] = mhlo.subtract %[[TEMP_61]], %[[TEMP_16]] : tensor<f32>
// CHECK: %[[TEMP_125:.*]] = mhlo.select %[[TEMP_121]], %[[TEMP_123]], %[[TEMP_124]] : tensor<i1>, tensor<f32>
// CHECK: %[[TEMP_126:.*]] = mhlo.select %[[TEMP_115]], %[[TEMP_119]], %[[TEMP_125]] : tensor<i1>, tensor<f32>
// CHECK: %[[TEMP_127:.*]] = mhlo.select %[[TEMP_110]], %[[TEMP_114]], %[[TEMP_126]] : tensor<i1>, tensor<f32>
// CHECK: %[[TEMP_128:.*]] = mhlo.multiply %[[TEMP_127]], %[[TEMP_112]] : tensor<f32>
// CHECK: %[[TEMP_129:.*]] = mhlo.sqrt %[[TEMP_128]] : tensor<f32>
// CHECK: %[[TEMP_130:.*]] = mhlo.divide %[[TEMP_9]], %[[TEMP_129]] : tensor<f32>
// CHECK: %[[TEMP_131:.*]] = mhlo.add %[[TEMP_127]], %[[TEMP_129]] : tensor<f32>
// CHECK: %[[TEMP_132:.*]] = mhlo.log_plus_one %[[TEMP_131]] : tensor<f32>
// CHECK: %[[TEMP_133:.*]] = mhlo.select %[[TEMP_110]], %[[TEMP_130]], %[[TEMP_132]] : tensor<i1>, tensor<f32>
// CHECK: %[[TEMP_134:.*]] = mhlo.select %[[TEMP_90]], %[[TEMP_103]], %[[TEMP_133]] : tensor<i1>, tensor<f32>
// CHECK: %[[TEMP_135:.*]] = mhlo.complex %[[TEMP_78]], %[[TEMP_134]] : tensor<complex<f32>>
// CHECK: %[[TEMP_136:.*]] = mhlo.imag %[[TEMP_135]] : (tensor<complex<f32>>) -> tensor<f32>
// CHECK: %[[TEMP_137:.*]] = mhlo.negate %[[TEMP_136]] : tensor<f32>
// CHECK: %[[TEMP_138:.*]] = mhlo.select %[[TEMP_2]], %[[TEMP_137]], %[[TEMP_136]] : tensor<i1>, tensor<f32>
// CHECK: %[[TEMP_139:.*]] = mhlo.real %[[TEMP_135]] : (tensor<complex<f32>>) -> tensor<f32>
// CHECK: %[[TEMP_140:.*]] = mhlo.atan2 %[[TEMP_3]], %[[TEMP_139]] : tensor<f32>
// CHECK: %[[TEMP_141:.*]] = mhlo.complex %[[TEMP_138]], %[[TEMP_140]] : tensor<complex<f32>>
// CHECK: return %[[TEMP_141]] : tensor<complex<f32>>
...
// CHECK: %[[TEMP_18:.*]] = mhlo.constant dense<2.000000e+00> : tensor<f32>
// CHECK: %[[TEMP_19:.*]] = mhlo.sqrt %[[TEMP_18]] : tensor<f32>
// CHECK: %[[TEMP_20:.*]] = mhlo.multiply %[[TEMP_19]], %[[TEMP_15]] : tensor<f32>
// CHECK: %[[TEMP_21:.*]] = mhlo.divide %[[TEMP_16]], %[[TEMP_15]] : tensor<f32>
// CHECK: %[[TEMP_22:.*]] = mhlo.multiply %[[TEMP_21]], %[[TEMP_21]] : tensor<f32>
// CHECK: %[[TEMP_23:.*]] = mhlo.add %[[TEMP_10]], %[[TEMP_22]] : tensor<f32>
// CHECK: %[[TEMP_24:.*]] = mhlo.sqrt %[[TEMP_23]] : tensor<f32>
// CHECK: %[[TEMP_25:.*]] = mhlo.compare  EQ, %[[TEMP_24]], %[[TEMP_10]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
...
// CHECK: %[[TEMP_29:.*]] = mhlo.multiply %[[TEMP_15]], %[[TEMP_22]] : tensor<f32>
// CHECK: %[[TEMP_30:.*]] = mhlo.divide %[[TEMP_29]], %[[TEMP_18]] : tensor<f32>
// CHECK: %[[TEMP_31:.*]] = mhlo.add %[[TEMP_15]], %[[TEMP_30]] : tensor<f32>
// CHECK: %[[TEMP_32:.*]] = mhlo.multiply %[[TEMP_15]], %[[TEMP_24]] : tensor<f32>
// CHECK: %[[TEMP_33:.*]] = mhlo.select %[[TEMP_28]], %[[TEMP_31]], %[[TEMP_32]] : tensor<i1>, tensor<f32>
// CHECK: %[[TEMP_34:.*]] = mhlo.select %[[TEMP_17]], %[[TEMP_20]], %[[TEMP_33]] : tensor<i1>, tensor<f32>
...
// CHECK: %[[TEMP_40:.*]] = mhlo.multiply %[[TEMP_19]], %[[TEMP_37]] : tensor<f32>
...
// CHECK: %[[TEMP_46:.*]] = mhlo.compare  GT, %[[TEMP_42]], %[[TEMP_26]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK: %[[TEMP_47:.*]] = mhlo.and %[[TEMP_45]], %[[TEMP_46]] : tensor<i1>
// CHECK: %[[TEMP_48:.*]] = mhlo.multiply %[[TEMP_37]], %[[TEMP_42]] : tensor<f32>
// CHECK: %[[TEMP_49:.*]] = mhlo.divide %[[TEMP_48]], %[[TEMP_18]] : tensor<f32>
...
// CHECK: %[[TEMP_85:.*]] = mhlo.log %[[TEMP_18]] : tensor<f32>
...
// CHECK: %[[TEMP_93:.*]] = mhlo.select %[[TEMP_91]], %[[TEMP_92]], %[[TEMP_26]] : tensor<i1>, tensor<f32>
